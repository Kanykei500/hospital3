...
public class PatientController {
    ...
    public String savePatient(@PathVariable Long hospitalId, @ModelAttribute("newPatient") Patient patient) {
    ...
    public String updatePatient(@PathVariable("hospitalId")Long hospitalId,@PathVariable("patientId")Long patientId,@ModelAttribute("patient") Patient patient){
